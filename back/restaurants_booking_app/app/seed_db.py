...
def seed_data():
    ...
    INSERT INTO public."Restaurant" (
        ...
        (1, 'Вкусный уголок', 'ул. Пушкина, 10', '+7-900-123-45-67', NOW(), 59.9343, 30.3351, 9, 0, 22, 0),
        (2, 'Солнечный берег', 'пр. Ленина, 50', '+7-900-234-56-78', NOW(), 55.7558, 37.6173, 10, 30, 23, 0),
        (3, 'Лесная сказка', 'ул. Гагарина, 7', '+7-900-345-67-89', NOW(), 56.8389, 60.6057, 8, 0, 21, 30)
